// Command server is the hanfu-rental backend entrypoint.
package main
...
import (
	...
	"github.com/lp/hanfu-rental/internal/router"
...
func main() {
	...
	if err := db.AutoMigrate(
		&model.User{}, &model.Hanfu{}, &model.MakeupPackage{}, &model.Photographer{},
		&model.RentalOrder{}, &model.Activity{}, &model.ActivityRegistration{},
		&model.MemberCard{}, &model.Article{},
	); err != nil {
	...
	go func() {
		logger.Info("hanfu-rental server listening", slog.String("port", cfg.Port))
